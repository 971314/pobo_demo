...
var InfoList = React.createClass({
  render: function() {
    var creatContents = function(content) {
      ...
      return (
        <a className="list-group-item clearfix" href={href}>
          <span className="title" dangerouslySetInnerHTML={{__html: content.Title}} />
          <span className="time">{time[0]}</span>
        </a>
      );
    };
    return (<div className="list-group">{this.props.contents.map(creatContents, this)}</div>);
  }
});
  ...
  if (typeof pbEngine != "undefined") {
    ...
    function callback(message) {
      ...
      if (msg.moduleId == 90004) {
        ...
        ReactDOM.render(<InfoList contents={CONTENTS} />, document.getElementById('info-list'));
      }
    }
        ...
        case 0:
          ...
          if (!data0) {
            $.post(url(data)[0],function (data) {
              var CONTENTS = JSON.parse(data).Indexes;
              ReactDOM.render(<InfoList contents={CONTENTS} dir={dirStr} />, infoListDom);
            })
          } else {
            ReactDOM.render(<InfoList contents={data0} dir={dirStr} />, infoListDom);
          }
          flag = 0;
          break;
        case 1:
          ...
          if (!data1) {
            ...
            ReactDOM.render(<InfoList contents={data1} dir={dirStr} />, infoListDom);
          }
          flag = 1;
          break;
        case 2:
          ...
          if (!data2) {
            ...
            ReactDOM.render(<InfoList contents={data2} dir={dirStr} />, infoListDom);
          }
          flag = 2;
          break;
        case 3:
          ...
          if (!data3) {
            ...
            ReactDOM.render(<InfoList contents={data3} dir={dirStr} />, infoListDom);
          }
          flag = 3;
          break;
        case 4:
          ...
          if (!data4) {
            ...
            ReactDOM.render(<InfoList contents={data4} dir={dirStr} />, infoListDom);
          }
          flag = 4;
          break;
        case 5:
          ...
          if (!data5) {
            ...
            ReactDOM.render(<InfoList contents={data5} dir={dirStr} />, infoListDom);
          }
          flag = 5;
          break;
        case 6:
          ...
          if (!data6) {
            ...
            ReactDOM.render(<InfoList contents={data6} dir={dirStr} />, infoListDom);
          }
          flag = 6;
          break;
        case 7:
          ...
          if (!data7) {
            ...
            ReactDOM.render(<InfoList contents={data7} dir={dirStr} />, infoListDom);
          }
          flag = 7;
          break;
        case 8:
          ...
          if (!data8) {
            ...
            ReactDOM.render(<InfoList contents={data8} dir={dirStr} />, infoListDom);
          }
          flag = 8;
          break;
        default:

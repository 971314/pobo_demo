...
var PageOneContent = React.createClass({
  ...
  render: function() {
    return React.DOM.div(null,
      ...
      React.DOM.p(null, 'This is a multi-page boilerplate template that you can copy to buil your first jQuery Mobile page. This template contains multiple "page" containers inside, unlike a single page template that has just one page within it.'),

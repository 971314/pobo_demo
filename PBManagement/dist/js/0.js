...
Component.options.__file = "E:\\ml\\ex\\PBManagement\\src\\components\\RoleQuery.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] RoleQuery.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-33837ac0", Component.options)
  } else {
    hotAPI.reload("data-v-33837ac0", Component.options)
  }
...
var update = __webpack_require__(534)("2851d633", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-33837ac0\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./RoleQuery.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-33837ac0\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./RoleQuery.vue");
...
exports.default = {
  ...
  methods: {
    ...
    setCheckedKeys: function setCheckedKeys(roleAuzsData) {
      var pids = [];
      for (var i = 0, l = roleAuzsData.length; i < l; i++) {
        var code = roleAuzsData[i].code;
        var hasChild = false;
        for (var j = 0; j < l; j++) {
    ...
    getAuzsData: function getAuzsData(rid) {
      var _this = this;
      _this.relateError = '';
      var params = {
        func: '613',
    ...
    onEdit: function onEdit(roleData) {
    ...
    onRelate: function onRelate(roleData) {
      this.roleData = roleData;
    ...
    onAddAuz: function onAddAuz(store, data, event) {
    ...
    onEditAuz: function onEditAuz(store, data, event) {
      event.stopPropagation();
      console.dir(data);
      this.auzData = data;
      this.query = false;
              ...
              'el-button',
              {
                ...
                on: {
                  'click': function click($event) {
                    return _this2.onAddAuz(store, data, $event);
                  }
                }
              },
              ['\u589E\u52A0']
          ...
          [h(
            ...
            [h(
              'el-button',
              {
                ...
                on: {
                  'click': function click($event) {
                    return _this2.onEditAuz(store, data, $event);
                  }
                }
              },
              ['\u4FEE\u6539']
    ...
    onSubmitRelate: function onSubmitRelate() {
      var _this = this;
      _this.submitRelateStatus = true;
      _this.relateError = '';
      var pids = _this.getCheckedKeys().join('|');
      _this.$axios.post(PBConf.routerURL, {
        func: '616',
        uid: _this.userInfo.userId,
        token: _this.userInfo.token,
    ...
    onSubmitAuz: function onSubmitAuz() {
      var _this = this;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(scope) {
        return [_c('el-button', {
          ...
          on: {
            "click": function($event) {
              _vm.onRelate(scope.row)
            }
          }
        }, [_vm._v("权限关联")])]
      }
    }])
  })], 1)], 1)], 1)], 1) : _vm._e(), _vm._v(" "), (_vm.edit) ? _c('div', {
  ...
  }, [_vm._v("提交")])], 1)], 1)], 1) : _vm._e(), _vm._v(" "), (_vm.relate) ? _c('div', {
  ...
  }, [_vm._v("返回")]), _vm._v("\n      " + _vm._s(_vm.roleData.roleName) + "的权限\n      "), _c('el-button', {
    attrs: {
      "type": "primary",
      "loading": _vm.submitRelateStatus
    },
    on: {
      "click": function($event) {
        _vm.onSubmitRelate()
  ...
  }, [_vm._v("关联权限")])], 1), _vm._v(" "), (_vm.relateError) ? _c('div', {
    staticClass: "error"
  }, [_c('p', [_vm._v(_vm._s(_vm.relateError))])]) : _vm._e(), _vm._v(" "), _c('el-input', {
    attrs: {
  ...
  })], 1) : _vm._e(), _vm._v(" "), (_vm.addAuz || _vm.editAuz) ? _c('div', {
    staticClass: "user-form"
  }, [_c('el-form', {
    ref: "form",
    attrs: {
  ...
  })], 1), _vm._v(" "), (_vm.addAuz || _vm.auzData.children.length == 0) ? _c('el-form-item', {
    attrs: {
      "label": "节点url"
    }
  }, [_c('el-input', {
  ...
  })], 1) : _vm._e(), _vm._v(" "), (_vm.auzError) ? _c('el-form-item', {
    staticClass: "error"
  }, [_c('p', [_vm._v(_vm._s(_vm.auzError))])]) : _vm._e(), _vm._v(" "), _c('el-form-item', [_c('el-button', {
    attrs: {
      "type": "primary"
    },
    on: {
    ...
    attrs: {
      "type": "primary",
      "loading": _vm.submitAuzStatus
    },
    on: {
      "click": _vm.onSubmitAuz
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-33837ac0", module.exports)
  }
}
